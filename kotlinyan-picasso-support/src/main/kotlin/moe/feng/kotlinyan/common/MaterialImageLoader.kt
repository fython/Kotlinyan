...
class MaterialImageLoader private constructor(internal val imageView: ImageView) {
	...
	private val drawable: Drawable = imageView.drawable
	private var duration = DEFAULT_DURATION
	private var saturation: Float = 0.toFloat()
	private var animationSaturation: ValueAnimator? = null
	private var animationContrast: ValueAnimator? = null
	private var animationAlpha: ObjectAnimator? = null
